...
# Import the function to be tested. The implementation filename contains a hyphen,
# so it must be loaded dynamically rather than with a regular import statement.
